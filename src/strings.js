...
export const strings = {
  ...
  *Whoops, something went wrong\!*
  ...
  noMoreServiceToday: dedent`
  ⚠️ It seems like it's quite late\. It could be that there are no more buses for the day\.
  `,

  serviceEndingWarning: dedent`
  ⚠️ It's getting late\! The bus service will be ending soon\.
  `,
